...
import {getCurrentLocation, selectFirestore, sortMasjidData1} from '../store/firebase';
        ...
        <Card
            ...
            <Card.Actions>
                <View style={{width: '100%'}}>
                    ...
                    <View style={{flexDirection: 'row', backgroundColor: '#EDEDED', padding: 10, borderRadius: 10}}>
