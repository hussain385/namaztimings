                            ...
                            <View>
                                ...
                                <View style={{flexDirection: 'row', marginTop: 10}}>
                                    ...
                                    <View
                                        ...
                                        <Text style={{fontSize: 17}}>{masjidData[0].timings.fajar}</Text>
                                    </View>
                                </View>
                                <View style={{flexDirection: 'row', marginTop: 10}}>
                                    <View
                                    ...
                                    <View
                                        ...
                                        <Text style={{fontSize: 17}}>{masjidData[0].timings.zohar}</Text>
                                    </View>
                                </View>
                                <View style={{flexDirection: 'row', marginTop: 10}}>
                                    <View
                                    ...
                                    <View
                                        ...
                                        <Text style={{fontSize: 17}}>{masjidData[0].timings.asar}</Text>
                                    </View>
                                </View>
                                <View style={{flexDirection: 'row', marginTop: 10}}>
                                    <View
                                    ...
                                    <View
                                        ...
                                        <Text style={{fontSize: 17}}>{masjidData[0].timings.magrib}</Text>
                                    </View>
                                </View>
                                <View style={{flexDirection: 'row', marginTop: 10}}>
                                    <View
                                    ...
                                    <View
                                        ...
                                        <Text style={{fontSize: 17}}>{masjidData[0].timings.isha}</Text>
                                    </View>
                                </View>
                                <View
                                    style={{
